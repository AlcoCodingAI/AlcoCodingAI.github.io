...
> ZASADA (2026-09-19, bez wyjątków): NIGDY nie używaj podwójnego myślnika (em-dash, U+2014).
> Pauza i myślnik dialogowy to zawsze półpauza (U+2013). Dotyczy wpisów, opisów,
> szablonów i dokumentacji. `nowy-wpis.ps1` normalizuje to automatycznie przy generowaniu.
...
(Placeholdery usunięte 2026-09-19 po przepisaniu prawdziwych postów.)
